...
$(document).ready(function() {
    $("#save_data").submit(function(event) {
       ...
       // Almacena los nombres de los campos faltantes
        ...
        if (!name) missingFields.push(message_error_form61);
        if (!iso3) missingFields.push(message_error_form62);
        if (!phone_code) missingFields.push(message_error_form63);
        if (!capital) missingFields.push(message_error_form64);
        if (!currency_name) missingFields.push(message_error_form65);
        if (!currency_symbol) missingFields.push(message_error_form66);
        if (!region) missingFields.push(message_error_form67);
