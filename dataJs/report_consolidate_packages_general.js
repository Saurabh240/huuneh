...
function cdp_load(page) {
  ...
  $("#loader").fadeIn("slow");
  $.ajax({
    url: "./ajax/reports/report_consolidate_packages_general_ajax.php",
    data: parametros,
...
function cdp_exportExcel() {
  ...
  window.open(
    "report_consolidate_packages_general_excel.php?range=" +
      daterange +
      "&status_courier=" +
      status_courier +
      "&agency=" +
...
function cdp_exportPrint() {
  ...
  window.open(
    "report_consolidate_packages_general_print.php?range=" +
      daterange +
      "&status_courier=" +
      status_courier +
      "&agency=" +
