...
$(document).ready(function() {
    $("#save_data").submit(function(event) {
       ...
       // Almacena los nombres de los campos faltantes
        ...
        if (!mod_style) missingFields.push(message_error_form56);
        if (!detail) missingFields.push(message_error_form57);
        if (!color) missingFields.push(message_error_form58);
            ...
            success: function(response) {
                ...
                if (response.status === 'success') {
                    Swal.fire({
                        ...
                        window.location.href = 'status_courier_list.php';
                    });
                } else {
                    Swal.fire({
                        type: 'error',
