...
function cdp_load(page) {
	...
	var parametros = { "page": page, 'search': search, 'origin': origin, 'destiny': destiny, 'business_type': business_type };
	$("#loader").fadeIn('slow');
	$.ajax({
		url: './ajax/tools/flat_price/flat_price_list_ajax.php',
		data: parametros,
    ...
    swal({
        ...
        preConfirm: function() {
            return new Promise(function(resolve) {
                $.ajax({
                        url: './ajax/tools/flat_price/flat_price_delete_ajax.php',
                        type: 'POST',
                        data: {
                            'id': id,
                        },
