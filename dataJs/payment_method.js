...
$(document).ready(function() {
    $("#save_data").submit(function(event) {
        ...
        var met_payment = $('#met_payment').val(); 
       ...
       // Almacena los nombres de los campos faltantes
        ...
        if (!met_payment) missingFields.push(message_error_form39);
        if (!detail) missingFields.push(message_error_form40);
            ...
            success: function(response) {
                ...
                if (response.status === 'success') {
                    Swal.fire({
                        ...
                        window.location.href = 'payment_methods_list.php';
                    });
                } else {
                    Swal.fire({
                        type: 'error',
