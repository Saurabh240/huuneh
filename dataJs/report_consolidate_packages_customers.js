...
function cdp_load(page) {
  ...
  $("#loader").fadeIn("slow");
  $.ajax({
    url: "./ajax/reports/report_consolidate_packages_customers_ajax.php",
    data: parametros,
...
function cdp_exportExcel() {
  ...
  window.open(
    "report_consolidate_packages_customers_excel.php?range=" +
      daterange +
      "&status_courier=" +
      status_courier +
      "&customer_id=" +
...
function cdp_exportPrint() {
  ...
  window.open(
    "report_consolidate_packages_customers_print.php?range=" +
      daterange +
      "&status_courier=" +
      status_courier +
      "&customer_id=" +
