...
$(document).ready(function() {
    $("#save_data").submit(function(event) {
       ...
       // Almacena los nombres de los campos faltantes
        ...
        if (!country) missingFields.push(message_error_form68);
        if (!state_name) missingFields.push(message_error_form69);
        if (!iso) missingFields.push(message_error_form70);
            ...
            success: function(response) {
                ...
                if (response.status === 'success') {
                    Swal.fire({
                        ...
                        window.location.href = 'states_list.php';
                    });
                } else {
                    Swal.fire({
                        type: 'error',
