...
function getRatesByDeliveryTypeAndBusinessType1($deliveryType, $businessType) {
    $rates = [
      'default' => [
          ...
          'NEXT DAY (BEFORE 9PM)' => ['baseRate' => 5.00, 'additionalRatePerKm' => 0.50, 'baseKm' => 10],
      ...
      'flower_shop' => [
          ...
          'NEXT DAY (BEFORE 9PM)' => ['baseRate' => 5.00, 'additionalRatePerKm' => 0.33, 'baseKm' => 15],
      ...
      'flower_shop_2' => [
          ...
          'NEXT DAY (BEFORE 9PM)' => ['baseRate' => 7.00, 'additionalRatePerKm' => 0.00, 'baseKm' => 15],
