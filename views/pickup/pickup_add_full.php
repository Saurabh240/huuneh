                                        ...
                                        <!-- <div class="form-group col-md-3">
											...
											<div class="form-group col-md-3">
                                                    ...
                                                    <select class="form-control custom-select" id="deliveryType" name="deliveryType" required style="width: 100%;">
														...
														<option <?php if(time() > strtotime("2:00 PM")) { echo "disabled='disabled' class='disabled-cls'"; }?>value="SAMEDAY (BEFORE 9PM)">SAMEDAY (BEFORE 9PM)</option>
														<option <?php if(time() > strtotime("1:00 PM")) { echo "disabled='disabled' class='disabled-cls'"; }?>value="SAMEDAY (BEFORE 7PM)">SAMEDAY (BEFORE 7PM)</option>
										 ...
										 <div class="input-group mb-3">
											   <input type="number" id="admin_discount" name="admin_discount" min="0" step="1" class="form-control">
